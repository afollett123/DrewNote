...
public class NoteDictionarySortedArray implements NoteCollection{
	...
	public boolean remove1(Note note) {
		Node n = head;
		while(n!=null) {
	...
	public boolean contains1(long ID) {
		Node n = head;
		while(n!=null) {
			if(n.note.getID() == ID) {
				return true;
